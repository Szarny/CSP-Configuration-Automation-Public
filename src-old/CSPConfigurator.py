...
def configure_csp(csp_info_db, parsed_html):
    """
    CSPを自動構成する
    ...
    connect_src_csp_list = configure_connect_src_domain(connect_src_list)
...
def configure_connect_src_domain(connect_src_list):
    """
    connect-srcを構成する
